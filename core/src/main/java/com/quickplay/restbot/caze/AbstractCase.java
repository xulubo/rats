...
import static com.quickplay.restbot.caze.MetaName.commonparams;
import static com.quickplay.restbot.caze.MetaName.id;
import static com.quickplay.restbot.caze.MetaName.method;
import static com.quickplay.restbot.caze.MetaName.path;
...
import com.quickplay.restbot.param.CollectionParamValue;
...
public abstract class AbstractCase {
	...
	final public String buildUrl() {
		if (this.url == null) {
			...
			if (StringUtils.isNotBlank(p)) {
				p = p.trim();
				builder.query(com.quickplay.restbot.utils.ParamUtils.extend(p, context.getParamMap()));
			}
