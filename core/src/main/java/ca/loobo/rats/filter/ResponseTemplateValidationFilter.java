...
import static ca.loobo.rats.caze.MetaName.resourcefolder;
import static ca.loobo.rats.caze.MetaName.responsetemplate;
...
import ca.loobo.rats.json.FieldIgnorableComparator;
